...
2026-07-23 Phase 2-S0과 Phase 2-S1 Gate를 완료했다. 보정 근거, 0 W, nearest-visible energy와 strict schema 계약에 더해 collimator·mirror 실제 ray-plane hit, no-teleport miss, off-axis ideal-lens chief ray, scanner pivot, target `width_axis`, one/two-sided material 정책과 mirror/footprint base-refined quadrature 수렴 판정이 현재 기준이다. 다음 활성 단계는 UI-S 편집·시각화 안정화다.
